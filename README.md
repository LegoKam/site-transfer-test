...
## Environments
- Preview: https://main--site-transfer-test--LegoKam.aem.page/
- Live: https://main--site-transfer-test--LegoKam.aem.live/
...
1. Open the `site-transfer-test` directory in your favorite IDE and start coding :)
